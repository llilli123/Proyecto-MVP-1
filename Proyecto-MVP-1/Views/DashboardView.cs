...
namespace Proyecto_MVP_1.Views
{
    public partial class DashboardView : Form, IDashboardView
    {
        ...
        private void buttonNavClientes_Click(object sender, EventArgs e)
        {
            NavigateToClientes?.Invoke(this, EventArgs.Empty);
        }

        private void buttonNavEquipos_Click(object sender, EventArgs e)
        {
            NavigateToEquipos?.Invoke(this, EventArgs.Empty);
        }

        private void buttonNavAlquileres_Click(object sender, EventArgs e)
        {
